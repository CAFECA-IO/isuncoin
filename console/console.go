...
// Welcome show summary of current iSunCoin instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the iSunCoin JavaScript console!\n\n"

	// Print some generic iSunCoin metadata
