...
Currently, only the Ethereum mainnet and the default supported test networks (bolt) activate this feature. If you want to activate this feature in your private network, you can overwrite the relevant checkpoint oracle settings through the configuration file after deploying the oracle contract.
