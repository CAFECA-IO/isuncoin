...
var (
	...
	boltFlag    = flag.Bool("bolt", false, "Initializes the faucet with Bolt network config")
...
func main() {
	...
	genesis, err := getGenesis(*genesisFlag, *boltFlag, *goerliFlag, *rinkebyFlag, *sepoliaFlag)
	if err != nil {
...
func getGenesis(genesisFlag string, boltFlag bool, goerliFlag bool, rinkebyFlag bool, sepoliaFlag bool) (*core.Genesis, error) {
	switch {
	case genesisFlag != "":
		...
		return &genesis, err
	case boltFlag:
		return core.DefaultBoltGenesisBlock(), nil
	case goerliFlag:
